...
<html>
  ...
  function getHash(form){
	...
	<meta http-equiv="refresh" content="0;nojs.html">
        ...
        <title>Coins Prealpha 01 - Registro</title> 
    </head>
    <body onload="alerta();">
        ...
        <script>
         ...
         <script>
                function alerta() {
                    //un alert
                    alertify.alert("<b>ERROR!!</b> Ya existe este correo electronico en nuestra base de datos", function () {
